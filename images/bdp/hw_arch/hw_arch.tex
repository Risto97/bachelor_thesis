...
\begin{tikzpicture}[thick]
  ...
  \node[inner sep=7pt, inner ysep =30pt, draw,dashed, thick,fit=(img_ram) (rd_addrgen) (ii_gen) (features_mem) (sii_gen) (frame_buffer) (stddev) (classifier)] (ip_core) {};
  ...
  \path [line] (detected_addr) -- +(3.0cm, 0cm) node[transition, yshift=0.25cm, xshift=-1.1cm]{\large detected\_addr} ;
