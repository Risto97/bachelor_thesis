...
\begin{tikzpicture}[thick]
  ...
  \node [operator, right=1.0cm of sum0] (leaf_lt) {\large \textbf{$<$}};
  ...
  \node [coordinate, left=9.75cm of mult0_in0] (stddev){};
  ...
  \node [multiplexer, right=2.5cm of leaf_lt] (mux0) {};
  ...
  \node [operator, below=2.5cm of accum_stage] (stage_lt) {\large \textbf{$<$}};
  ...
  \path [line] (sum0_out) -- (leaf_lt_in0);
  \path [line] (mult0_out) -- (leaf_lt_in1);

  \path [line] (leaf_lt_out) -- (mux0_sel);

  \path [line] (leaf0_out) -- (leaf0_port) -| (mux0_in0);
  \path [line] (leaf1_out) -- (leaf1_port) -| (mux0_in1);

  \path [line] (mux0_out) -- (accum_stage_in);
